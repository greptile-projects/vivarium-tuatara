...
type Plan = {
  ...
  cutover?: {state:string;source_state:string;candidate_id:string;pause_kinds:string[];cleanup_policy:string;authority:string;approvals?:{actor_id:string;destination_id:string;decision:string}[];destinations:{destination_id:string;repository_id?:string;state:string;revision?:string;health:string}[];observations?:{kind:string;resource_id:string;state:string;evidence:string;actor_id:string}[]};
  authority: string;
};
