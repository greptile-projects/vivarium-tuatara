...
type OutcomeDecision = { id:string; version:number; experiment_version:number; analysis_id:string; decision:string; variant_key?:string; rationale:string; cleaned_up:boolean; tasks:{id:string;kind:string;title:string;required:boolean;status:string;evidence?:{kind:string;resource_id:string};completed_by?:string}[] };
type RunAttempt = {
