...
function AgentProfileWorkspace({ group, owner, submit }: { group: Organization; owner: boolean; submit: (path: string, init: RequestInit) => Promise<void> }) {
