      ...
      <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <div className="mt-3 flex flex-wrap gap-4">
            ...
            <Link href={`/repositories/${id}/capacity`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Capacity objectives</Link>
            <Link href={`/repositories/${id}/response-policies`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Response coverage</Link>
            <Link href={`/repositories/${id}/runbooks`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Operational runbooks</Link>
            <Link href={`/repositories/${id}/observability`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Observability gaps</Link>
            ...
            <Link href={`/repositories/${id}/provenance/assessments`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Provenance readiness</Link>
            ...
            <Link href={`/repositories/${id}/interface-system`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Interface system</Link>
            <Link href={`/repositories/${id}/capabilities`} className="text-sm font-semibold text-[var(--brand)] hover:underline">Capability inventory</Link>
