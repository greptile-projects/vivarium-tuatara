...
type Contract = {
  ...
  improvements: {id:string;objective_id:string;investigation_id?:string;finding_id?:string;impact_id?:string;baseline_observation_ids:string[];affected_observation_ids:string[];affected_revisions:string[];dependency_context:string[];evidence_ids:string[];acceptance_criteria:string[];proposal_id:string;task_ids:string[];created_by:string}[];
