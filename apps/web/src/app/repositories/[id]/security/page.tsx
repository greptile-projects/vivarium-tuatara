...
import { SecurityScenariosWorkspace } from "@/components/security-scenarios-workspace";
...
export default async function SecurityPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="space-y-12"><SecurityExpectationsWorkspace repositoryID={id} /><ThreatModelsWorkspace repositoryID={id} /><SecurityScenariosWorkspace repositoryID={id} /></div>;
}
