...
export type Incubator = {
  ...
  delivery_plans: {
    ...
    work_items: {
      id: string;
      kind: "code" | "tests" | "documentation" | "infrastructure" | "interface";
      title: string;
      repository_id: string;
  ...
  launch_readiness: {
    ...
    declared_audience: "experimental" | "limited" | "public";
    effective_audience: "experimental" | "limited" | "public";
    ready: boolean;
    blockers: string[];
    evidence: {
      dimension: string;
      ...
      reference: string;
      status:
        "current" | "missing" | "unsafe" | "unsupported" | "failed" | "stale";
      risk?: string;
    }[];
    decisions: {
      dimension: string;
  ...
  project_launches: {
    ...
    version: number;
    readiness_id: string;
    audience: "experimental" | "limited" | "public";
    artifacts: {
      kind:
        | "release"
        | "documentation"
    ...
    work: {
      id: string;
      kind: "roadmap_revision" | "proposal_task";
      repository_id: string;
      resource_id: string;
      owner_type: "human" | "agent";
      owner_id: string;
    ...
    transition?: {
      disposition:
        "organization_initiative" | "experimental" | "merged" | "archived";
...
export type ConflictCitation = {
  side: "base" | "source" | "target" | "proposed";
  revision: string;
  path: string;
  evidence_id?: string;
};
...
export type DevelopmentWorkspace = {
  ...
  conflict_context?: {
    ...
    resolutions: {
      ...
      state: "proposed" | "applying" | "applied" | "undoing" | "undone";
      uncertainty: string;
      preservation: {
        kind:
          ...
          | "user_behavior";
        reference: string;
        disposition: "preserved" | "intentionally_changed";
        rationale: string;
        citations: ConflictCitation[];
      }[];
      authorship: ConflictAuthorship;
      applied_by?: ConflictAuthorship;
      created_at: string;
      applied_at?: string;
      undone_at?: string;
    }[];
