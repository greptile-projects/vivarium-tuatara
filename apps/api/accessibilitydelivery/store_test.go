...
func TestExactCandidateEvidenceAcknowledgementDissentAndOverride(t *testing.T) {
	...
	readiness, err := s.Evaluate(repo, revision, "main", []string{"src/ui/button.tsx"}, nil, []string{"high"}, map[string]string{"axe": "passed"}, evidence)
	...
	readiness, _ = s.Evaluate(repo, revision, "main", []string{"src/ui/button.tsx"}, nil, []string{"high"}, map[string]string{"axe": "passed"}, evidence)
	...
	readiness, _ = s.Evaluate(repo, "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", "main", []string{"src/ui/button.tsx"}, nil, []string{"high"}, map[string]string{"axe": "passed"}, evidence)
	if readiness.Ready {
