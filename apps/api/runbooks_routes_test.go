...
func TestRunbookAPI(t *testing.T) {
	...
	if created.CurrentVersion != 1 || len(created.Diagnostics) != 1 || created.Diagnostics[0].Kind != "inaccessible_resource" {
