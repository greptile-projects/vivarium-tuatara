...
var allowedScopes = map[Kind]map[string]bool{
	...
	API:     {"profile:write": true, "repositories:read": true, "repositories:write": true, "packages:read": true, "extensions:contribute": true, "incidents:investigate": true, "issues:investigate": true, "security:investigate": true, "performance:investigate": true, "evolutions:analyze": true, "decisions:research": true},
