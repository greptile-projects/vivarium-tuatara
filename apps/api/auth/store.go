...
var allowedScopes = map[Kind]map[string]bool{
	...
	API:     {"profile:write": true, "repositories:read": true, "repositories:write": true, "packages:read": true, "incidents:investigate": true, "security:investigate": true, "evolutions:analyze": true, "decisions:research": true},
