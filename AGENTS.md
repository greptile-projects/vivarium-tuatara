...
boundaries. Stable requests reconcile retries; correlation keys append related events without
duplicating pages. Active exact-policy rotations narrow delivery to the effective shift owner.
